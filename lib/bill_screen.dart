                    ...
                    child: Row(
                      children: [
                        InkWell(
                          ...
                          child: Container(
                            width: blockSizeHorizontal *
                                25, //MediaQuery.of(context).size.width / 5,
                        ...
                        SizedBox(
                          ...
                          width: blockSizeHorizontal *
                              69, //MediaQuery.of(context).size.width / 1.4,
                          child: InkWell(
                            onTap: () {
                              cubit.trueDate();
                              showDialog(
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                        ...
                        height: blockSizeVertical *
                            36, //MediaQuery.of(context).size.height / 3.8,
                        child: Card(
                                                                      ...
                                                                      children: <
                                                                        ...
                                                                        StatefulBuilder(
                                                                          builder:
                                                                            ...
                                                                            return AlertDialog(
                                                                              title: const Text('  هل تريد حذف هذه المادة  '),
                                                                              content: Form(
                                                                                key: cubit.formkey,
